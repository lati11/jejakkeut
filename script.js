        ...
        <div class="flex-grow flex flex-wrap items-center justify-between gap-x-4 gap-y-2 p-2 border rounded-md bg-gray-50">
            ...
            <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <input type="number" data-type="required" placeholder="개수" 
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="flex items-center gap-1 py-0.2 px-2 border border-gray-200 rounded-md bg-white">
                    ...
                    <input type="number" data-type="unit-price"
                           class="w-32 py-1 px-2 border-none rounded-md text-right focus:ring-0 focus:border-none">
    ...
    wrapper.innerHTML = `
        <div class="flex-grow flex flex-wrap items-center justify-center gap-x-64 gap-y-2 p-2 border rounded-md bg-gray-50">
            <div class="flex items-center gap-2">
                ...
                <input type="number" data-type="outcome-amount"
